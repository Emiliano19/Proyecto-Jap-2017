...
namespace DataAccess
{
    public class PersonajeDA
    {
        ...
        public static int Modificar(Personaje P)
        {
            ...
            {
                connection.Open();
                string query = "UPDATE Personaje SET [Nombre] = @Nombre, [Nivel] = @Nivel, [Fuerza] = @Fuerza, [Destreza] = @Destreza, [Constitución] = @Constitución, [Inteligencia] = @Inteligencia, [Sabiduria] = @Sabiduria, [Carisma] = @Carisma, [IdR] = @IdR, [IdC] = @IdC WHERE [IdPer] = @IdPer";
