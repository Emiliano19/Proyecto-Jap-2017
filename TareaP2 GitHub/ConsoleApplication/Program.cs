    ...
    public class Program
    {
        static void Main(string[] args)
        {
            ...
            while (ENTRAMAYOR)
            {
                ...
                Console.WriteLine("     1-Personaje        2-Raza            3-Clase            4-Habilidad        5-Caracteristica        6-Comandos Extra  ");
                ...
                else if (NumMAYOR == 2)
                {
                    ...
                    {
                        Console.WriteLine();
                        Console.Write("Ingrese Valor del comando a ejecutar: ");
                ...
                Console.WriteLine();
                Console.WriteLine("Si desea que el Programa Finalise ingrese: 6");
                Console.WriteLine();
                Console.WriteLine("Si quiere continuar ingrese el comando elejido a continuación");
                Console.WriteLine();
