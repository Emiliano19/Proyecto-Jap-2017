...
namespace DataAccess
{
    public class HabilidadEspecialDA
    {
        ...
        public static int Modificar(Habilidad_Especial HES)
        {
            ...
            {
                connection.Open();
                string query = "UPDATE Raza SET [Nombre] = @Nombre, [Descripción] = @Descripcion WHERE [IdHE] = @IdHE";
        ...
        public static int Eliminar(Habilidad_Especial HES)
        {
            ...
            {
                connection.Open();
                string query = "Delete Habilidad_Especial WHERE [IdHE] = @id";

                SqlCommand com = new SqlCommand(query, connection);
                com.Parameters.AddWithValue("@id", HES.Id);
